...
template <bool bIsLoading, bool bIsTextFormat>
void TSaveGameSerializer<bIsLoading, bIsTextFormat>::InitiateLevelLoad(const TSoftObjectPtr<ULevel>& Level)
{
	const FString MapName = Level->GetOutermost()->GetLoadedPath().GetPackageName();
